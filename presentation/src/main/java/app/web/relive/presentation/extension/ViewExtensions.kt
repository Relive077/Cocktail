package app.web.relive.presentation.extension
...
fun ImageView.load(
    url: String?,
    @DrawableRes placeholderRes: Int = app.web.relive.presentation.alcoholiccocktails.R.drawable.ic_cloud_download,
